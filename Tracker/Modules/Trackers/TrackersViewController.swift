...
final class TrackersViewController: UIViewController {
    ...
    private var visibleCategories: [TrackerCategory] {
        ...
        for category in categories {
            ...
            result.append(TrackerCategory(name: category.name, array: trackersByDay))
...
extension TrackersViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func numberOfSections(in collectionView: UICollectionView) -> Int {
        //let itemCount = categories.count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        var counter = completedTrackers.filter { $0.id == tracker.id }.count
        
        var isComplete = completedTrackers.filter { $0.id == tracker.id && $0.date == currentDate }.count > 0
